...
- The 24.1 Progress entry represents the actual tester only. Keep 24.1 primers, movement baselines, EMOMs, and interval sessions in their workout logs, but do not list them as separate Progress movements.
