const exerciseDisplayNameAliases = new Map([
  ...
  ["push press", "Shoulder Push Press"],
  ...
  ["incline dumbbell press", "Bench Press Incline Dumbbell"],
  ["incline db press", "Bench Press Incline Dumbbell"],
  ["dumbbell incline press", "Bench Press Incline Dumbbell"],
  ["db incline press", "Bench Press Incline Dumbbell"],
  ...
  ["kettle bell squatclean", "Squat Clean Kettlebell"],
  ["kettlebell squatclean", "Squat Clean Kettlebell"],
  ["kettle bell squat clean", "Squat Clean Kettlebell"],
  ["kettlebell squat clean", "Squat Clean Kettlebell"],
  ["kb squat clean", "Squat Clean Kettlebell"],
  ["squat clean kettle bell", "Squat Clean Kettlebell"],
  ["squat clean kettlebell", "Squat Clean Kettlebell"],
  ["squat clean kb", "Squat Clean Kettlebell"],
...
function normalizeExerciseDisplayName(value) {
  ...
  if (assaultBikeShortMaxCal) {
    ...
    return `Assault Bike ${duration}${duration === "2:30" ? "" : " Min"} Max Cal`;
  }
...
function is300RepChallenge(value) {
...
const defaultStrengthMovements = [
  ...
  { key: "push-press", name: "Shoulder Push Press" },
